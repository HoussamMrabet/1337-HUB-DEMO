  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-16 md:bottom-6 right-6 z-50 p-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 group animate-in slide-in-from-bottom-6"
      >
